...
<h1 style="font-family: IBMPlexSansKR-Regular">판매글쓰기</h1>
...
<td width="900px"><input type="text" name="subject" style="border: none;" size="100"></td>
<td width="100px" style="background-color:#71c4e9; font-weight: 600;" align="center">작성자</td>
<td><input type="text" name="writer" size="50" value="<%=session.getAttribute("memberName")%>" readonly="readonly" style="border: none"></td>
...
<table>
<tr>
<td colspan="2"><textarea name="content" style="width: 100%; height: 400px;" cols="700" rows="300" placeholder="내용을 입력하세요"></textarea></td>
</tr>

<tr>
<td><input type="file" name="filename" value="사진첨부"></td>
<td style="text-align: right;" ><input type="button" id="button" value="확인" onclick="check();"></td>
</tr>
</table>
